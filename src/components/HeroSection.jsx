  ...
  return(
    <div className="relative flex flex-col items-center p-4 pt-28 pb-10 sm:pt-28 sm:pb-28 gap-10">
      ...
      <div className="flex justify-center items-center gap-4 z-10">
        <a href="#contact-section" className="text-center rounded-lg font-bold p-1.5 w-32 bg-gradient-to-br from-black to-slate-500 text-white dark:from-zinc-50 dark:to-zinc-400 dark:text-black transition ease-in-out delay-500">
          Contact
        </a>
      ...
      <div className="flex items-center justify-center absolute top-0 right-0 left-0 bottom-0 overflow-hidden">
        <Image className="sm:hidden block h-full invert dark:invert-0" width={768} height={768} src={'/background/hero-background-dark-768-squared.png'} alt={'hero background image'}></Image>
