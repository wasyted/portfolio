...
export default function Header({navEntryList}){
  return(
    <header className="shadow-lg bg-blend-lighten bg-[#0d0d0d] backdrop-blur-lg flex justify-between items-center p-2 px-0 fixed top-0 sm:left-10 sm:right-10 z-50 rounded-lg rounded-tl-none rounded-tr-none">
