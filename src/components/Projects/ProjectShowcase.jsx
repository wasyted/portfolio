  ...
  return (
    <div
      ...
      <motion.div
        ...
        style={{translateX}}
      >
        <p className="absolute text-nowrap top-5 xl:top-0 text-[100px] xl:text-[150px] xl:mt-10 tracking-tighter max-w-[1920px] w-full font-black">EVERYTHING RESPONSIVE EVERYTHING RESPONSIVE EVERYTHING RESPONSIVE EVERYTHING RESPONSIVE EVERYTHING RESPONSIVE EVERYTHING RESPONSIVE</p>
      </motion.div>
      <motion.div
        ...
        className="max-w-1/2">
        <div className="hidden xl:flex gap-x-4 items-end justify-center gap-[-10] mt-10">
          <motion.div
      ...
      <motion.div
        ...
        whileInView={{ skewY: 0, translateY: 0, opacity: 1}}
        className="max-w-4xl">
        <div className="flex xl:hidden mx-auto items-end justify-center mt-10">
          <motion.div
            initial={{ opacity: 0, translateY: 50, skewY: 0, translateX: 100  }}
            transition={{ ease: "easeInOut", delay: 0.8, duration: 0.5 }}
            whileInView={{ skewY: 0, translateY: 0, opacity: 1,  translateX: 100 }}
            className="flex-1 z-30 hidden md:static"
          >
            <Image
              className="z-30 max-w-48 xl:max-w-sm"
              src={"/iPad-PRO-11-localhost.png"} width={680} height={942} alt="ipad" />
          </motion.div>
          <motion.div
            initial={{ opacity: 0, translateY: 100, translateX: 30  }}
            transition={{ ease: "easeInOut", delay: 0.2, duration: 0.5 }}
            whileInView={{ skewY: 0, translateY: 0, opacity: 1, translateX: 30  }}
            className="flex-1 z-20 static"
          >
            <Image
              className="z-30 max-w-md xl:max-w-6xl"
              src={"/Macbook-Air-localhost (2).png"} width={1466} height={862} alt="mac" />
          </motion.div>
          <motion.div
            initial={{ opacity: 0, translateY: 20, translateX: -50 }}
            transition={{ ease: "easeInOut", delay: 0.5, duration: 0.5 }}
            whileInView={{ translateY: 0, opacity: 1, translateX: -50  }}
            className="flex-1 z-30 static"
          >
            <Image
              className="z-30 max-w-20 xl:max-w-48"
              src={"/iPhone-13-PRO-MAX-localhost.png"} width={468} height={944} alt="iphone" />
          </motion.div>
        </div>
      </motion.div>
