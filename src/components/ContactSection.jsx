...
export default function Contact(){
  return(
    <div id='contact-section' className="shadow-xl flex min-h-screen flex-col justify-center items-center gap-10 p-4 pt-0 bg-white dark:text-white dark:bg-gradient-to-t dark:from-black dark:to-slate-800 pt-10 z-10">
      <div className="text-center p-4">
        ...
        <p className="text-zinc-800 dark:text-zinc-200 text-xl max-w-sm mt-3">
      ...
      <form className="flex flex-col justify-center items-start gap-4  w-full max-w-lg p-2">
        ...
        <button type='submit' onClick={(event) => {event.preventDefault()}} className="rounded-lg font-bold p-1.5 w-32 bg-gradient-to-br from-black to-slate-600 dark:from-white dark:to-zinc-200 dark:text-black text-white transition ease-in-out delay-500">
          Submit
        </button>
